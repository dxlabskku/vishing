...
os.system(f'python {args.model_name}.py --feature_time {args.feature_time} --feature_type {args.feature_type} --checkpoints_path {args.checkpoints_path} --result_path {args.result_path} --wav_path {args.num_test} --gpu_id {args.gpu_id}')
